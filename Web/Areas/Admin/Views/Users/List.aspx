<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="BasePage<UsersList>" %>
...
<asp:Content ContentPlaceHolderID="BeginFormContent" runat="server"><%=
	Html.Cortex().BeginForm("Admin", "Users", "List", Model.PageID)
%></asp:Content>
	...
	<div id="title-pane">
		...
		<table class="filters">
			<tr>
				...
				%></td>
				<% if (SI.PermittedForms.Exists(x => String.Concat(x.Area, x.Controller, x.Action) == "AdminUsersEdit"))
				{ %>
					<td class="option"><%
